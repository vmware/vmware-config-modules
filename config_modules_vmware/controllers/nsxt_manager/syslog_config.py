...
class SyslogConfig(BaseController):
    ...
    metadata = ControllerMetadata(
        ...
        path_in_schema="compliance_config.nsxt_manager.syslog",  # path in the schema to this controller's definition.
        ...
        products=[
            ...
            NSXTManagerContext.ProductEnum.NSXT_EDGE,
    ...
    def get(self, context: NSXTManagerContext) -> Tuple[Dict, List[Any]]:
        ...
        try:
            ...
            raise Exception(f"Exception retrieving syslog values from NSXCLI: {str(e)}")
    ...
    def set(self, context: NSXTManagerContext, desired_values: Dict) -> Tuple[str, List[Any]]:
        ...
        try:
            ...
            desired_syslog_servers = desired_values
