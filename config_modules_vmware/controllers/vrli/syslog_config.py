...
class SyslogConfig(BaseController):
    ...
    | Config Id - 0000
    | Config Title - Placeholder title for Vrli SYSLOG control

    """

    metadata = ControllerMetadata(
        name="syslog",  # controller name
        path_in_schema="compliance_config.vrli.syslog",  # path in the schema to this controller's definition.
        configuration_id="0",  # configuration id as defined in compliance kit.
        title="Placeholder title for VRLI SYSLOG control",
    ...
    def check_compliance(self, context: VrliContext, desired_values: Any) -> Dict:
        ...
        :rtype: dict
        """
        # vrli only needs servers for SYSLOG control
