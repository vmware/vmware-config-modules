...
class SyslogConfig(BaseController):
    ...
    | Config Id - 0000
    | Config Title - Placeholder title for VRA SYSLOG control

    """

    metadata = ControllerMetadata(
        name="syslog",  # controller name
        path_in_schema="compliance_config.vra.syslog",  # path in the schema to this controller's definition.
        configuration_id="0",  # configuration id as defined in compliance kit.
        title="Placeholder title for VRA SYSLOG control",
        # controller title as defined in compliance kit.
        tags=[],  # controller tags for future querying and filtering
        version="1.0.0",  # version of the controller implementation.
        since="",  # version when the controller was first introduced in the compliance kit.
        products=[VraContext.ProductEnum.VRA],  # product from enum in VraContext.
    ...
    def get(self, context: VraContext) -> Tuple[Dict, List[Any]]:
        """
        Get SYSLOG config from Vra.
        ...
        :param context: VRA context
        :type context: VraContext
    ...
    def check_compliance(self, context: VraContext, desired_values: Any) -> Dict:
        """Check compliance of current configuration against provided desired values.

        :param context: VRA product context instance.
        :type context: VraContext
        ...
        :rtype: dict
        """
        # vra only needs servers for SYSLOG control
        # protocol is not set in the vrli integration for vra.  removing from the comparision
    ...
    def set(self, context: VraContext, desired_values: Dict) -> Tuple[str, List[Any]]:
        """
        Set SYSLOG config in VRA.
        ...
        :param context: VRA context instance.
        :type context: VraContext
        ...
        try:
            ...
            logger.info(f"Current VRA SYSLOG servers: {current_syslog_servers}")
            logger.info(f"Desired VRA SYSLOG servers: {desired_syslog_servers}")
    ...
    def remediate(self, context: VraContext, desired_values: Any) -> Dict:
