...
class SyslogConfig(BaseController):
    ...
    | Config Id - 0000
    | Config Title - Placeholder title for Vidm SYSLOG control

    """

    metadata = ControllerMetadata(
        name="syslog",  # controller name
        path_in_schema="compliance_config.vidm.syslog",  # path in the schema to this controller's definition.
        configuration_id="0",  # configuration id as defined in compliance kit.
        title="Placeholder title for VIDM SYSLOG control",
    ...
    @staticmethod
    def _update_syslog(syslog_servers: List[Any]) -> bool:
        """
        Add SYSLOG server.
    ...
    def check_compliance(self, context: VidmContext, desired_values: Any) -> Dict:
        ...
        :rtype: dict
        """
        # vidm only needs servers for SYSLOG control
