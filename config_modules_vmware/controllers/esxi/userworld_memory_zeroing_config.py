...
SETTINGS_NAME = "Mem.MemEagerZero"


class UserworldMemoryZeroingConfig(BaseController):
    ...
    metadata = ControllerMetadata(
        name="userworld_memory_zeroing_config",  # controller name
        path_in_schema="compliance_config.esxi.userworld_memory_zeroing_config",
        # path in the schema to this controller's definition.
        configuration_id="1122",  # configuration id as defined in compliance kit.
    ...
    def get(self, context: HostContext) -> Tuple[int, List[str]]:
        ...
        :return: Tuple of integer and a list of error messages.
        :rtype: Tuple
        """
        logger.info("Getting Mem.MemEagerZero configuration for esxi.")
        errors = []
        mem_eager_zero = -1
        try:
            ...
            mem_eager_zero = result[0].value
        except Exception as e:
            logger.exception(f"An error occurred: {e}")
            errors.append(str(e))
        return mem_eager_zero, errors
    ...
    def set(self, context: HostContext, desired_values) -> Tuple[RemediateStatus, List[str]]:
        ...
        :type context: HostContext
        :param desired_values: 1 to enable or 0 to disable userworld memory zeroing.
        :type desired_values: int
        :return: Tuple of "status" and list of error messages.
        :rtype: Tuple
        """
        logger.info("Setting Mem.MemEagerZero configuration for esxi.")
