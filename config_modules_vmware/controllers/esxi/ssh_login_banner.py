...
SETTINGS_NAME = "Config.Etc.issue"


class SshLoginBanner(BaseController):
    ...
    metadata = ControllerMetadata(
        name="ssh_login_banner",  # controller name
        path_in_schema="compliance_config.esxi.ssh_login_banner",
        # path in the schema to this controller's definition.
        configuration_id="123",  # configuration id as defined in compliance kit.
    ...
    def get(self, context: HostContext) -> Tuple[str, List[str]]:
        ...
        :return: Tuple of ssh login banner string and a list of error messages.
        :rtype: Tuple
        """
    ...
    def set(self, context: HostContext, desired_values) -> Tuple[RemediateStatus, List[str]]:
        ...
        :type context: HostContext
        :param desired_values: Desired value of ssh login banner.
        :type desired_values: str
        :return: Tuple of "status" and list of error messages.
        :rtype: Tuple
        """
        logger.info("Setting ssh login banner for esxi")
