...
SETTINGS_NAME = "UserVars.SuppressShellWarning"


class SuppressShellWarningPolicy(BaseController):
    ...
    metadata = ControllerMetadata(
        name="suppress_shell_warning",  # controller name
        path_in_schema="compliance_config.esxi.suppress_shell_warning",
        # path in the schema to this controller's definition.
        configuration_id="30",  # configuration id as defined in compliance kit.
    ...
    def get(self, context: HostContext) -> Tuple[int, List[str]]:
        ...
        :rtype: Tuple
        """
        logger.info("Getting suppress shell warning policy for esxi.")
        errors = []
        ...
        try:
            ...
            suppress_shell_warning = result[0].value
        except Exception as e:
            logger.exception(f"An error occurred: {e}")
            errors.append(str(e))
        return suppress_shell_warning, errors
    ...
    def set(self, context: HostContext, desired_values) -> Tuple[RemediateStatus, List[str]]:
        ...
        :param context: Esxi context instance.
        :type context: HostContext
        :param desired_values: 1 to enable suppress and 0 to disable suppress shell warning.
        :type desired_values: int
        :return: Tuple of "status" and list of error messages.
        :rtype: Tuple
        """
        logger.info("Setting suppress shell warning policy for esxi")
