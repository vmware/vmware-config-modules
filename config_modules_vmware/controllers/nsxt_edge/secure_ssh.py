...
class SecureSSH(BaseController):
    ...
    This is a common controller implementation for both nsxt edge and nsxt edge.

    | Config Id - 0000
    | Config Title - NSX Edge must use SSHv2 with at least 2048 modulus key size

    """

    metadata = ControllerMetadata(
        name="secure_ssh",  # controller name
        path_in_schema="compliance_config.nsxt_edge.secure_ssh",  # path in the schema to this controller's definition.
        ...
        products=[
            NSXTEdgeContext.ProductEnum.NSXT_MANAGER
    ...
    def set(self, context: NSXTEdgeContext, desired_values) -> Tuple[RemediateStatus, List[str]]:
