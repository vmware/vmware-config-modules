...
from config_modules_vmware.controllers.esxi.syslog_strict_x509_compliance import SETTINGS_NAME
...
class TestSyslogStrictX509Compliance:
    def setup_method(self):
        ...
        self.desired_configs = True
        self.non_compliant_configs = False
