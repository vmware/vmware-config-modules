...
from config_modules_vmware.controllers.esxi.syslog_strict_x509_compliance import SyslogStrictX509Compliance
...
class TestSyslogStrictX509Compliance:
    def setup_method(self):
        self.controller = SyslogStrictX509Compliance()
    ...
    def test_get_failed_cli_not_returning_x509_compliance_policy(self):
        cli_return_value = "   Allow Vsan Backing: false\n" \
                           "   Log Level: error"
        expected_error = "Unable to fetch strict x509 compliance using command esxcli system syslog config get"
