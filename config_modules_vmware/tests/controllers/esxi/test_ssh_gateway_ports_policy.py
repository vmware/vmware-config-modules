...
from config_modules_vmware.controllers.esxi.ssh_gateway_ports_policy import SshGatewayPortsPolicy
from config_modules_vmware.tests.controllers.esxi.test_ssh_host_based_auth_policy import HelperTestSshConfigControls


class TestSshGatewayPortsPolicy:
    def setup_method(self):
        self.controller = SshGatewayPortsPolicy()
