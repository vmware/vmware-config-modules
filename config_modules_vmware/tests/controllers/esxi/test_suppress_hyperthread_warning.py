...
from config_modules_vmware.controllers.esxi.hyperthread_warning_policy import HyperthreadWarningPolicy
from config_modules_vmware.controllers.esxi.hyperthread_warning_policy import SETTINGS_NAME
from config_modules_vmware.tests.controllers.esxi.test_password_max_lifetime_policy import HelperTestEsxAdvControls


class TestHyperthreadWarningPolicy:
    def setup_method(self):
        self.controller = HyperthreadWarningPolicy()
