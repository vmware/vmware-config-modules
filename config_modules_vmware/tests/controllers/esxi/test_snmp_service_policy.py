...
from config_modules_vmware.controllers.esxi.snmp_service_policy import SnmpServicePolicy
from config_modules_vmware.framework.auth.contexts.esxi_context import HostContext
from config_modules_vmware.framework.clients.common import consts
from config_modules_vmware.framework.models.output_models.compliance_response import ComplianceStatus
from config_modules_vmware.framework.models.output_models.remediate_response import RemediateStatus

ESXI_SERVICE_SNMP = "snmpd"

class TestSnmpServicePolicy:
    def setup_method(self):
        self.controller = SnmpServicePolicy()
        ...
        self.host_service.serviceInfo.service = [MagicMock(key=ESXI_SERVICE_SNMP, running=False, policy="off")]
    ...
    def test_check_compliance_compliant2(self):
        self.host_service.serviceInfo.service = [MagicMock(key=ESXI_SERVICE_SNMP, running=True, policy="off")]
        expected_result = {consts.STATUS: ComplianceStatus.COMPLIANT}
    ...
    def test_check_compliance_non_compliant(self):
        self.host_service.serviceInfo.service = [MagicMock(key=ESXI_SERVICE_SNMP, running=True, policy="on")]
        expected_result = {
    ...
    def test_check_compliance_non_compliant2(self):
        self.host_service.serviceInfo.service = [MagicMock(key=ESXI_SERVICE_SNMP, running=False, policy="on")]
        expected_result = {
            consts.STATUS: ComplianceStatus.NON_COMPLIANT,
