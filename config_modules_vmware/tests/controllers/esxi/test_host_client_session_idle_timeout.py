...
from config_modules_vmware.controllers.esxi.host_client_session_idle_timeout import HostClientSessionIdleTimeout
from config_modules_vmware.controllers.esxi.host_client_session_idle_timeout import SETTINGS_NAME
from config_modules_vmware.tests.controllers.esxi.test_password_max_lifetime_policy import HelperTestEsxAdvControls


class TestHostClientSessionIdleTimeout:
    def setup_method(self):
        self.controller = HostClientSessionIdleTimeout()
        self.desired_configs = 900
