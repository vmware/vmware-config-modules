...
from config_modules_vmware.controllers.esxi.suppress_shell_warning_policy import SETTINGS_NAME
from config_modules_vmware.controllers.esxi.suppress_shell_warning_policy import SuppressShellWarningPolicy
from config_modules_vmware.tests.controllers.esxi.test_password_max_lifetime_policy import HelperTestEsxAdvControls


class TestSuppressShellWarningPolicy:
    def setup_method(self):
        self.controller = SuppressShellWarningPolicy()
        self.desired_configs = 0
        self.non_compliant_configs = 1
