...
from config_modules_vmware.controllers.esxi.ad_esx_admin_group_config import AdEsxAdminGroupConfig
from config_modules_vmware.controllers.esxi.ad_esx_admin_group_config import SETTINGS_NAME
from config_modules_vmware.tests.controllers.esxi.test_password_max_lifetime_policy import HelperTestEsxAdvControls


class TestAdEsxAdminGroupConfig:
    def setup_method(self):
        self.controller = AdEsxAdminGroupConfig()
        self.desired_configs = ""
        self.non_compliant_configs = "ESX Admins"
