...
from config_modules_vmware.controllers.esxi.userworld_memory_zeroing_config import SETTINGS_NAME
from config_modules_vmware.controllers.esxi.userworld_memory_zeroing_config import UserworldMemoryZeroingConfig
from config_modules_vmware.tests.controllers.esxi.test_password_max_lifetime_policy import HelperTestEsxAdvControls


class TestUserworldMemoryZeroingConfigr:
    def setup_method(self):
        self.controller = UserworldMemoryZeroingConfig()
