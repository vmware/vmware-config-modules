...
from config_modules_vmware.controllers.esxi.ssh_fips_140_2_crypt_config import SshFips140_2CryptConfig
...
class TestSshFips140_2CryptConfig:
    def setup_method(self):
        self.controller = SshFips140_2CryptConfig()
