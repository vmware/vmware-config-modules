...
from config_modules_vmware.controllers.esxi.ssh_login_banner import SETTINGS_NAME
from config_modules_vmware.controllers.esxi.ssh_login_banner import SshLoginBanner
from config_modules_vmware.tests.controllers.esxi.test_password_max_lifetime_policy import HelperTestEsxAdvControls


class TestSshLoginBanner:
    def setup_method(self):
        self.controller = SshLoginBanner()
        self.desired_configs = "Sample SSH login banner"
