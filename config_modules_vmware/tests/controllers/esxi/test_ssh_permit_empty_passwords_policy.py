...
from config_modules_vmware.controllers.esxi.ssh_permit_empty_passwords_policy import SshPermitEmptyPasswordsPolicy
...
class TestSshPermitEmptyPasswordsPolicy:
    def setup_method(self):
        self.controller = SshPermitEmptyPasswordsPolicy()
