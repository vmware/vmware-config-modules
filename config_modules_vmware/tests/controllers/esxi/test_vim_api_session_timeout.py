...
from config_modules_vmware.controllers.esxi.vim_api_session_timeout import SETTINGS_NAME
from config_modules_vmware.controllers.esxi.vim_api_session_timeout import VimApiSessionTimeout
from config_modules_vmware.tests.controllers.esxi.test_password_max_lifetime_policy import HelperTestEsxAdvControls


class TestVimApiSessionTimeout:
    def setup_method(self):
        self.controller = VimApiSessionTimeout()
        self.desired_configs = 30
