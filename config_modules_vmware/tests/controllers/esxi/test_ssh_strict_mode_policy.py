...
from config_modules_vmware.controllers.esxi.ssh_strict_mode_policy import SshStrictModePolicy
...
class TestSshStrictModePolicy:
    def setup_method(self):
        self.controller = SshStrictModePolicy()
