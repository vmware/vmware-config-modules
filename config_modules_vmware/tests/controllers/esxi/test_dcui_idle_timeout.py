...
from config_modules_vmware.controllers.esxi.dcui_idle_timeout import DcuiIdleTimeout
from config_modules_vmware.controllers.esxi.dcui_idle_timeout import SETTINGS_NAME
from config_modules_vmware.tests.controllers.esxi.test_password_max_lifetime_policy import HelperTestEsxAdvControls


class TestDcuiIdleTimeout:
    def setup_method(self):
        self.controller = DcuiIdleTimeout()
