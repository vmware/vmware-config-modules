...
from config_modules_vmware.controllers.esxi.ssh_permit_user_environment_policy import SshPermitUserEnvironmentPolicy
from config_modules_vmware.tests.controllers.esxi.test_ssh_host_based_auth_policy import HelperTestSshConfigControls


class TestSshPermitUserEnvironmentPolicy:
    def setup_method(self):
        self.controller = SshPermitUserEnvironmentPolicy()
