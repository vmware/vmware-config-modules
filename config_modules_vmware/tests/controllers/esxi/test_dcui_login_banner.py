...
from config_modules_vmware.controllers.esxi.dcui_login_banner import DcuiLoginBanner
from config_modules_vmware.controllers.esxi.dcui_login_banner import SETTINGS_NAME
from config_modules_vmware.tests.controllers.esxi.test_password_max_lifetime_policy import HelperTestEsxAdvControls


class TestDcuiLoginBanner:
    def setup_method(self):
        self.controller = DcuiLoginBanner()
        self.desired_configs = "Sample DCUI login banner"
