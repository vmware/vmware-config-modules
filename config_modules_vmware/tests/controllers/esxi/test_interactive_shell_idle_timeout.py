...
from config_modules_vmware.controllers.esxi.interactive_shell_idle_timeout import InteractiveShellIdleTimeout
from config_modules_vmware.controllers.esxi.interactive_shell_idle_timeout import SETTINGS_NAME
from config_modules_vmware.tests.controllers.esxi.test_password_max_lifetime_policy import HelperTestEsxAdvControls


class TestInteractiveShellIdleTimeout:
    def setup_method(self):
        self.controller = InteractiveShellIdleTimeout()
        self.desired_configs = 600
