...
from config_modules_vmware.controllers.esxi.bridge_protocol_data_unit_filter import BridgeProtocolDataUnitFilter
from config_modules_vmware.controllers.esxi.bridge_protocol_data_unit_filter import SETTINGS_NAME
from config_modules_vmware.tests.controllers.esxi.test_password_max_lifetime_policy import HelperTestEsxAdvControls


class TestBridgeProtocolDataUnitFilter:
    def setup_method(self):
        self.controller = BridgeProtocolDataUnitFilter()
        self.desired_configs = 1
        self.non_compliant_configs = 0
