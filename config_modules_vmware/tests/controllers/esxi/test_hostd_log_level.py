...
from config_modules_vmware.controllers.esxi.hostd_log_level import HostdLogLevel
from config_modules_vmware.controllers.esxi.hostd_log_level import SETTINGS_NAME
from config_modules_vmware.tests.controllers.esxi.test_password_max_lifetime_policy import HelperTestEsxAdvControls


class TestHostdLogLevel:
    def setup_method(self):
        self.controller = HostdLogLevel()
        self.desired_configs = "info"
