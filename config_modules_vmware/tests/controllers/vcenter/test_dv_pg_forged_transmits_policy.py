...
from config_modules_vmware.controllers.vcenter.dv_pg_forged_transmits_policy import DESIRED_KEY
from config_modules_vmware.controllers.vcenter.dv_pg_forged_transmits_policy import DVPortGroupForgedTransmitsPolicy
...
class TestDVPortGroupForgedTransmitsPolicyy:
    def setup_method(self):
        self.controller = DVPortGroupForgedTransmitsPolicy()
        self.compliant_dv_pgs = [
            {"switch_name": "SwitchB", "port_group_name": "dv_pg_PortGroup3", "allow_forged_transmits": False},
            {"switch_name": "SwitchC", "port_group_name": "dv_pg_PortGroup1", "allow_forged_transmits": False},
            {"switch_name": "SwitchA", "port_group_name": "dv_pg_PortGroup2", "allow_forged_transmits": False},
        ]
        self.non_compliant_dv_pgs = [
            {"switch_name": "SwitchB", "port_group_name": "dv_pg_PortGroup3", "allow_forged_transmits": True},
            {"switch_name": "SwitchC", "port_group_name": "dv_pg_PortGroup1", "allow_forged_transmits": True},
            {"switch_name": "SwitchA", "port_group_name": "dv_pg_PortGroup2", "allow_forged_transmits": False},
        ]
    ...
    def get_dv_port_group_mock_obj(self, pg_spec, create_bad_mock=False):
        ...
        dv_pg_mock.config.defaultPortConfig.securityPolicy.forgedTransmits = vim.BoolPolicy(
            value=pg_spec.get("allow_forged_transmits")
        )
    ...
    def test_set_success_ignore_disconnected_hosts(self, mock_vc_vmomi_client, mock_vc_context):
        expected_error = Exception("Failed to set Forged transmits policy, disconnected hosts")
        mock_vc_vmomi_client.get_objects_by_vimtype.return_value = self.non_compliant_dv_pg_pyvmomi_mocks
        mock_vc_vmomi_client.wait_for_task.side_effect = expected_error
        mock_vc_context.vc_vmomi_client.return_value = mock_vc_vmomi_client
