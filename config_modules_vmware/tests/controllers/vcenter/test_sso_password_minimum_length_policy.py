...
from config_modules_vmware.controllers.vcenter.sso_password_minimum_length_policy \
    import SSOPasswordMinimumLengthPolicy
from config_modules_vmware.framework.clients.common import consts
from config_modules_vmware.framework.models.output_models.compliance_response import ComplianceStatus
from config_modules_vmware.framework.models.output_models.remediate_response import RemediateStatus


class TestSSOPasswordMinimumLengthPolicy:
    def setup_method(self):
        self.controller = SSOPasswordMinimumLengthPolicy()
        self.compliant_value = 9
        self.non_compliant_value = 5
    ...
    def test_get_success(self, mock_vc_vmomi_sso_client, mock_vc_context):
        mock_vc_vmomi_sso_client.get_minimum_password_length.return_value = self.compliant_value
    ...
    def test_get_failed(self, mock_vc_vmomi_sso_client, mock_vc_context):
        expected_error = Exception("Failed to get SSO Password minimum length policy")

        mock_vc_vmomi_sso_client.get_minimum_password_length.side_effect = expected_error
        mock_vc_context.vc_vmomi_sso_client.return_value = mock_vc_vmomi_sso_client
    ...
    def test_set_failed_due_to_exception(self, mock_vc_vmomi_sso_client, mock_vc_context):
        ...
        mock_vc_vmomi_sso_client.enforce_minimum_password_length.side_effect = expected_error
        mock_vc_context.vc_vmomi_sso_client.return_value = mock_vc_vmomi_sso_client
    ...
    def test_check_compliance_non_compliant(self, mock_vc_vmomi_sso_client, mock_vc_context):
        ...
        mock_vc_vmomi_sso_client.get_minimum_password_length.return_value = self.non_compliant_value
        mock_vc_context.vc_vmomi_sso_client.return_value = mock_vc_vmomi_sso_client
