...
from config_modules_vmware.controllers.vcenter.vpx_syslog_enablement_config import VpxSyslogEnablementPolicy
from config_modules_vmware.framework.clients.common import consts
from config_modules_vmware.framework.models.output_models.compliance_response import ComplianceStatus
from config_modules_vmware.framework.models.output_models.remediate_response import RemediateStatus


class TestVpxSyslogEnablementPolicy:
    def setup_method(self):
        self.controller = VpxSyslogEnablementPolicy()
    ...
    def test_get_failed(self, mock_vc_vmomi_client, mock_vc_context):
        expected_error = Exception("Failed to get syslog enablement config")
    ...
    def test_set_failed_due_to_exception(self, mock_vc_vmomi_client, mock_vc_context):
        expected_error = Exception("Failed to set syslog enablement config")
    ...
    def test_set_failed_due_to_failed_update(self, mock_vc_vmomi_client, mock_vc_context):
        ...
        result, errors = self.controller.set(mock_vc_context, self.compliant_value)
        assert result == RemediateStatus.FAILED
        assert errors == ['Failed to set VPXD option value for vpxd.event.syslog.enabled']
