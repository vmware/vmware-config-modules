...
from config_modules_vmware.controllers.vcenter.sso_password_max_lifetime_policy \
    import SSOPasswordMaxLifetimePolicy
from config_modules_vmware.framework.clients.common import consts
from config_modules_vmware.framework.models.output_models.compliance_response import ComplianceStatus
from config_modules_vmware.framework.models.output_models.remediate_response import RemediateStatus


class TestSSOPasswordMaxLifetimePolicy:
    def setup_method(self):
        self.controller = SSOPasswordMaxLifetimePolicy()
        self.compliant_value = 90
        self.non_compliant_value = 900
    ...
    def test_get_success(self, mock_vc_vmomi_sso_client, mock_vc_context):
        mock_vc_vmomi_sso_client.get_password_lifetime_days.return_value = self.compliant_value
    ...
    def test_get_failed(self, mock_vc_vmomi_sso_client, mock_vc_context):
        expected_error = Exception("Failed to get SSO Password max lifetime days")

        mock_vc_vmomi_sso_client.get_password_lifetime_days.side_effect = expected_error
        mock_vc_context.vc_vmomi_sso_client.return_value = mock_vc_vmomi_sso_client
    ...
    def test_set_failed_due_to_exception(self, mock_vc_vmomi_sso_client, mock_vc_context):
        ...
        mock_vc_vmomi_sso_client.set_password_lifetime_days.side_effect = expected_error
        mock_vc_context.vc_vmomi_sso_client.return_value = mock_vc_vmomi_sso_client
    ...
    def test_check_compliance_non_compliant(self, mock_vc_vmomi_sso_client, mock_vc_context):
        ...
        mock_vc_vmomi_sso_client.get_password_lifetime_days.return_value = self.non_compliant_value
        mock_vc_context.vc_vmomi_sso_client.return_value = mock_vc_vmomi_sso_client
