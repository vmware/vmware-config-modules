...
from config_modules_vmware.controllers.vcenter.tls_version_config import UPDATE_COMMAND
...
class TestTlsVersion:
    ...
    def test_generate_remediate_commands_empty_data(self):
        result = self.controller._generate_remediate_commands({})
        assert result == []
