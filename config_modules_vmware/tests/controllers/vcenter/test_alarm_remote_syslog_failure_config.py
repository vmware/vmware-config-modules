...
class TestAlarmRemoteSyslogFailureConfig:
    ...
    def setup_method(self):
        ...
        self.mock_alarm_def1.info.description = "Mocked Alarm with expression eventType esx.problem.vmsyslogd.remote.failure"
        ...
        self.expected_alarms = [{
            ...
            'alarm_description': 'Mocked Alarm with expression eventType esx.problem.vmsyslogd.remote.failure',
            'enabled': True,
            'target_type': 'VCENTER',
            'rule_expressions': [
                {'state': 'CRITICAL',
