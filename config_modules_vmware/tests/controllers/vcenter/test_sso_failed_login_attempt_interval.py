...
from config_modules_vmware.controllers.vcenter.sso_failed_login_attempt_interval \
    import SSOFailedLoginAttemptInterval
from config_modules_vmware.framework.clients.common import consts
from config_modules_vmware.framework.models.output_models.compliance_response import ComplianceStatus
from config_modules_vmware.framework.models.output_models.remediate_response import RemediateStatus


class TestSSOFailedLoginAttemptInterval:
    def setup_method(self):
        self.controller = SSOFailedLoginAttemptInterval()
        self.compliant_value = 180
        self.non_compliant_value = 100
        self.error_condition = -180
    ...
    def test_get_success(self, mock_vc_vmomi_sso_client, mock_vc_context):
        mock_vc_vmomi_sso_client.get_interval_between_login_failures.return_value = self.compliant_value
    ...
    def test_get_failed(self, mock_vc_vmomi_sso_client, mock_vc_context):
        expected_error = Exception("Failed to get SSO Login attempt interval")

        mock_vc_vmomi_sso_client.get_interval_between_login_failures.side_effect = expected_error
        mock_vc_context.vc_vmomi_sso_client.return_value = mock_vc_vmomi_sso_client
    ...
    def test_set_failed_due_to_exception(self, mock_vc_vmomi_sso_client, mock_vc_context):
        ...
        mock_vc_vmomi_sso_client.set_interval_between_login_failures.side_effect = expected_error
        mock_vc_context.vc_vmomi_sso_client.return_value = mock_vc_vmomi_sso_client
    ...
    def test_check_compliance_non_compliant(self, mock_vc_vmomi_sso_client, mock_vc_context):
        ...
        mock_vc_vmomi_sso_client.get_interval_between_login_failures.return_value = self.non_compliant_value
        mock_vc_context.vc_vmomi_sso_client.return_value = mock_vc_vmomi_sso_client
