...
from config_modules_vmware.controllers.vcenter.sso_trusted_admins_authorized_members_config \
    import SSOTrustedAdminsAuthorizedMembersConfig
from config_modules_vmware.framework.clients.common import consts
from config_modules_vmware.framework.models.output_models.compliance_response import ComplianceStatus
from config_modules_vmware.framework.models.output_models.remediate_response import RemediateStatus


class TestSSOTrustedAdminsAuthorizedMembersConfig:
    def setup_method(self):
        self.controller = SSOTrustedAdminsAuthorizedMembersConfig()
        ...
        # mock a system domain group
        self.group_mock = MagicMock()
        self.group_mock.name = "TrustedAdmins"
