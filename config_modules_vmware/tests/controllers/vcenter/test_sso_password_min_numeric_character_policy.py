...
from config_modules_vmware.controllers.vcenter.sso_password_min_numeric_character_policy \
    import SSOPasswordMinNumericCharacterPolicy
...
class TestSSOPasswordMinLowercaseCharacterPolicy:
    def setup_method(self):
        self.controller = SSOPasswordMinNumericCharacterPolicy()
    ...
    def test_get_success(self, mock_vc_vmomi_sso_client, mock_vc_context):
        mock_vc_vmomi_sso_client.get_min_number_of_numeric_characters.return_value = self.compliant_value
    ...
    def test_get_failed(self, mock_vc_vmomi_sso_client, mock_vc_context):
        expected_error = Exception("Failed to get SSO Password min numeric character policy")

        mock_vc_vmomi_sso_client.get_min_number_of_numeric_characters.side_effect = expected_error
        mock_vc_context.vc_vmomi_sso_client.return_value = mock_vc_vmomi_sso_client
    ...
    def test_set_failed_due_to_exception(self, mock_vc_vmomi_sso_client, mock_vc_context):
        ...
        mock_vc_vmomi_sso_client.enforce_min_number_of_numeric_characters.side_effect = expected_error
        mock_vc_context.vc_vmomi_sso_client.return_value = mock_vc_vmomi_sso_client
    ...
    def test_check_compliance_non_compliant(self, mock_vc_vmomi_sso_client, mock_vc_context):
        ...
        mock_vc_vmomi_sso_client.get_min_number_of_numeric_characters.return_value = self.non_compliant_value
        mock_vc_context.vc_vmomi_sso_client.return_value = mock_vc_vmomi_sso_client
