...
from config_modules_vmware.controllers.vcenter.dv_pg_reserved_vlan_exclusion_policy import (
    DVPortGroupReservedVlanExclusionConfig
)
...
class TestDVPortGroupReservedVlanExclusionConfig:
    def setup_method(self):
        self.controller = DVPortGroupReservedVlanExclusionConfig()
