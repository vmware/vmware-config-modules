...
CreateManagedType(
    ...
    [
        ...
        (
            ...
            "CheckForUpdates",
            "vmodl.query.version.version1",
            (("version", "string", "vmodl.query.version.version1", F_OPTIONAL, None),),
            (
                F_OPTIONAL,
        ...
        (
            ...
            (
                ("version", "string", "vmodl.query.version.version3", F_OPTIONAL, None),
                (
                    "options",
        ...
        (
            ...
            "vmodl.query.version.version3",
            (),
            (0, "vmodl.query.PropertyCollector", "vmodl.query.PropertyCollector"),
            "System.View",
            None,
        ),
        (
...
CreateDataType(
    ...
    "vmodl.query.version.version1",
    [
        ("type", "vmodl.TypeName", "vmodl.query.version.version1", 0),
        ("all", "boolean", "vmodl.query.version.version1", F_OPTIONAL),
        ("pathSet", "vmodl.PropertyPath[]", "vmodl.query.version.version1", F_OPTIONAL),
    ],
)
CreateDataType(
    "vmodl.query.PropertyCollector.ObjectSpec",
    ...
    "vmodl.query.version.version1",
    [
        ("obj", "vmodl.ManagedObject", "vmodl.query.version.version1", 0),
        ("skip", "boolean", "vmodl.query.version.version1", F_OPTIONAL),
        (
            "selectSet",
...
CreateDataType(
    ...
    "vmodl.DynamicData",
    "vmodl.query.version.version1",
    [("name", "string", "vmodl.query.version.version1", F_OPTIONAL)],
)
CreateDataType(
    ...
    [
        ("type", "vmodl.TypeName", "vmodl.query.version.version1", 0),
        ("path", "vmodl.PropertyPath", "vmodl.query.version.version1", 0),
        ("skip", "boolean", "vmodl.query.version.version1", F_OPTIONAL),
        (
            "selectSet",
            "vmodl.query.PropertyCollector.SelectionSpec[]",
...
CreateDataType(
    ...
    "vmodl.query.version.version1",
    [
        ("version", "string", "vmodl.query.version.version1", 0),
        (
            "filterSet",
        ...
        ("truncated", "boolean", "vmodl.query.version.version3", F_OPTIONAL),
    ],
)
CreateDataType(
    "vmodl.query.PropertyCollector.FilterUpdate",
...
CreateDataType(
    ...
    [
        ...
        ("val", "anyType", "vmodl.query.version.version1", F_OPTIONAL),
    ],
)
CreateEnumType(
    "vmodl.query.PropertyCollector.Change.Op",
...
CreateDataType(
    ...
    [
        ("path", "vmodl.PropertyPath", "vmodl.query.version.version1", 0),
        ("fault", "vmodl.MethodFault", "vmodl.query.version.version1", 0),
    ],
)
CreateDataType(
    "vmodl.query.PropertyCollector.MissingObject",
...
CreateDataType(
    ...
    "vmodl.query.version.version3",
    [
        ("maxWaitSeconds", "int", "vmodl.query.version.version3", F_OPTIONAL),
        ("maxObjectUpdates", "int", "vmodl.query.version.version3", F_OPTIONAL),
    ],
)
CreateDataType(
    "vmodl.query.PropertyCollector.RetrieveOptions",
    ...
    "vmodl.DynamicData",
    "vmodl.query.version.version3",
    [("maxObjects", "int", "vmodl.query.version.version3", F_OPTIONAL)],
)
CreateDataType(
    "vmodl.query.PropertyCollector.RetrieveResult",
    "RetrieveResult",
    ...
    "vmodl.query.version.version3",
    [
        ("token", "string", "vmodl.query.version.version3", F_OPTIONAL),
        (
            "objects",
            "vmodl.query.PropertyCollector.ObjectContent[]",
            "vmodl.query.version.version3",
